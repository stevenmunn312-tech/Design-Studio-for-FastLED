...
try {
  const outfile = resolve('node_modules/.cache/gen-presence-compile-fixtures.mjs')
  await build({
    entryPoints: ['scripts/generate-presence-compile-fixtures.ts'], outfile, bundle: true,
