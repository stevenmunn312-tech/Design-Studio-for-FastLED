...
try {
  const outfile = resolve('node_modules/.cache/gen-ethernet-compile-fixtures.mjs')
  await build({
    entryPoints: ['scripts/generate-ethernet-compile-fixtures.ts'], outfile, bundle: true,
