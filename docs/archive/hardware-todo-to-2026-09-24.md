> **Archived 2026-09-24.** This is the backlog as it stood before it was
> restructured; the active list is [the root todo](../../todo.md). Kept for each
> item's evidence narrative. Nothing here is current.
...
- [x] **HW-01 · P1 · Slideshow selection and TFT-only firmware (M).** Code
  ...
  [the support matrix](../release/beta-support-matrix.md#auxiliary-display-hardware-validation)).
...
- [x] **HW-02 · P1 · Panel ownership and Enabled (M).** Rotation on a mounted
  ...
  [the support
  matrix](../release/beta-support-matrix.md#auxiliary-display-hardware-validation)):
...
- [ ] **HW-11 · Touch/LVGL budget and calibration (L; after HW-06).** One exact
  ...
  **Measured 2026-09-22 on the ESP32-2432S028R rig, and the budgets are set.**
  Five runs recorded in [the bench procedure](../development/testing/display-budget-bench.md):
...
- [ ] **HW-12 · Integrated display boards (M; after HW-11).** Verify controller
  ...
  *Bench evidence, 2026-09-14:* the stored pin map drove the real panel and
  ...
  [the support matrix](../release/beta-support-matrix.md). Internal
...
- [x] **HW-31 · P2 · The Build Diagram draws the microphone's pads down the
  ...
  *column*, so each of its three I2S wires got a distinct y for free — and no
  ...
  [Where a wire descends](../architecture/build-diagram.md#where-a-wire-descends).
...
- [x] **HW-25 · P2 · Fixed 64 KiB LVGL heap rules out classic-ESP32 custom
  ...
  *Original scoping, kept because the mechanism it describes is still accurate
  ...
  [the bench procedure](../development/testing/display-budget-bench.md).
  ...
  *One inconsistency is being held open on purpose (decided 2026-09-22).* The
  ...
  once the overflow is recorded — [the bench procedure](../development/testing/display-budget-bench.md)
