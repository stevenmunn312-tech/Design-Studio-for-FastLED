...
export const NODE_LIBRARY: NodeDefinition[] = [
  ...
  },
  {
    ...
    propertyInputs: { x: 'x', y: 'y', scroll: 'scroll' },
    outputs: [{ id: 'frame', label: 'Frame', dataType: 'frame' }],
    defaultProperties: {
  ...
  },
  {
    ...
    propertyInputs: { x1: 'x1', y1: 'y1', x2: 'x2', y2: 'y2' },
    outputs: [{ id: 'frame', label: 'Frame', dataType: 'frame' }],
  ...
  },
  {
    ...
    propertyInputs: { t: 't', scale: 'scale', thickness: 'thickness' },
    outputs: [{ id: 'frame', label: 'Frame', dataType: 'frame' }],
  ...
  },
  {
    ...
    propertyInputs: { glowAmount: 'glowAmount' },
    outputs: [{ id: 'frame', label: 'Frame', dataType: 'frame' }],
  ...
  },
  {
    ...
    propertyInputs: { vertical: 'vertical' },
    outputs: [{ id: 'frame', label: 'Frame', dataType: 'frame' }],
