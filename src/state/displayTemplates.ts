...
export const DISPLAY_TEMPLATES: readonly DisplayTemplate[] = [
  ...
  },
  {
    id: 'now-playing',
    label: 'Now Playing',
    description: 'A scrolling title, the artist, elapsed time against the track length, progress, and transport controls.',
    widgets: [
      widget('Text', 'Title', [16, 8, 288, 32], { text: 'Title', fontSize: 24, scroll: true }),
      widget('Text', 'Artist', [16, 48, 288, 24], { text: 'Artist' }),
      widget('Timecode', 'Elapsed', [16, 80, 80, 32]),
      widget('Timecode', 'Duration', [224, 80, 80, 32]),
    ...
    portraitWidgets: [
      widget('Text', 'Title', [16, 8, 208, 32], { text: 'Title', fontSize: 24, scroll: true }),
      widget('Text', 'Artist', [16, 48, 208, 24], { text: 'Artist' }),
      widget('Timecode', 'Elapsed', [16, 80, 80, 32]),
      widget('Timecode', 'Duration', [144, 80, 80, 32]),
