...
const KB2040_GPIO = boardPins({
  digital: [...range(0, 10), 12, 13, ...range(18, 20), ...range(26, 29)],
  analog: range(26, 29),
  labels: analogLabels(range(26, 29)),
  unavailable: {
    11: 'Not exposed on the KB2040',
    17: 'Connected to the on-board NeoPixel',
    21: 'Not exposed on the KB2040',
    22: 'Not exposed on the KB2040',
    23: 'Not exposed on the KB2040',
    24: 'Not exposed on the KB2040',
    25: 'Not exposed on the KB2040',
  },
})
...
export const BOARD_GPIO_BY_FQBN: Readonly<Record<string, BoardGpio>> = {
  ...
  'esp32:esp32:adafruit_feather_esp32_v2': ESP32_GPIO,
  'esp32:esp32:lolin_c3_mini': ESP32_C3_GPIO,
  ...
  'esp8266:esp8266:huzzah': ESP8266_GPIO,
  'esp8266:esp8266:d1_mini': ESP8266_GPIO,
  'esp8266:esp8266:generic': ESP8266_GPIO,
  'esp8266:esp8266:d1': ESP8266_GPIO,
  'arduino:avr:uno': UNO_GPIO,
  'arduino:avr:nano': NANO_GPIO,
  'arduino:avr:leonardo': LEONARDO_GPIO,
  'arduino:avr:micro': LEONARDO_GPIO,
  'SparkFun:avr:promicro': LEONARDO_GPIO,
  ...
  'teensy:avr:teensyMM': teensy(45, TEENSY_40_ANALOG),
  ...
  'rp2040:rp2040:rpipicow': PICO_GPIO,
  'rp2040:rp2040:rpipico2w': PICO_GPIO,
  'rp2040:rp2040:adafruit_kb2040': KB2040_GPIO,
  'arduino:mbed_nano:nanorp2040connect': PICO_GPIO,
  'arduino:samd:nano_33_iot': NANO_33_IOT_GPIO,
  'arduino:mbed_nano:nano33ble': NRF52840_GPIO,
  ...
  'arduino:renesas_uno:minima': UNO_R4_GPIO,
  'adafruit:nrf52:pca10056': NRF52840_GPIO,
  'adafruit:nrf52:feather52840': NRF52840_GPIO,
  'Seeeduino:nrf52:xiaonRF52840': NRF52840_GPIO,
}
