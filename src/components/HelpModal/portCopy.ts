...
export const OUTPUT_USE_CASES: Record<string, string> = {
  ...
  customdisplay: 'Its output identifies a designed screen. Wire it into a Display Panel’s Screen Design input to show that design instead of a fixed layout.',
...
export const PORT_DESCRIPTIONS: Record<string, string> = {
  ...
  customdisplay: 'a designed screen, ready to drive a Display Panel’s Screen Design input',
