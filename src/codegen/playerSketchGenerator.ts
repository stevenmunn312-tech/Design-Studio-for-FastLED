...
//   - ESP32-audioI2S-nopsram  (PLSousa/ESP32-audioI2S on GitHub)
//   - FastLED
//   - SD (built-in Arduino)
...
// "'Audio' does not name a type" at the first Audio declaration. Applies to
// <Audio.h> and <Audio_nopsram.h> alike — the trap is FastLED's header, not ours.
#include <Audio_nopsram.h>  // ESP32-audioI2S-nopsram
#include <FastLED.h>
