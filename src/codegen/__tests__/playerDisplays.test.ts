...
describe('displays in the player sketch', () => {
  ...
  it('emits the driver, the setup and the loop', () => {
    ...
    expect(sketch).toContain('_oledBeginSpi(_oled_oled, OLED_SH1106, 1, 2, 5, 6, 7, 128, 64, 2, 0xa0, 0xc0);')
  ...
  describe('a 4-pin panel', () => {
    ...
    it('brings in Wire, starts it, and begins the panel on it', () => {
      ...
      expect(src).toContain('_oledBeginI2c(_oled_oled, OLED_SSD1306, 0x3d, 128, 64, 0, 0xa0, 0xc0);')
