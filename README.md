...
**Public beta · 180 modules · 70 included patterns · Windows, macOS, and Linux packaging · MIT core**
...
- **A deep creative toolbox.** Choose from 180 modules spanning patterns, simulations, color, fields, effects, audio, logic, show control, hardware input, and output.
...
<details>
<summary><strong>Show all 180 modules by category</strong></summary>
