...
description: >
  ...
  JetBrains Mono taxonomy, Inter body, the four-accent palette. Composition,
...
typography:
  ...
  body-lg:    { fontFamily: "Inter", px: 28, cqw: 1.46, weight: 400, lineHeight: 1.4 }
  body-md:    { fontFamily: "Inter", px: 24, cqw: 1.25, weight: 400, lineHeight: 1.3 }
...
counter, and axis as a "technical artifact" register. **Inter** carries the few body lines.
