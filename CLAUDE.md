...
- **composite** (frame→frame): Blend, BrightnessMod, HueShift, Transform, Invert, Blur2D, Mask, Fade, Transition, Sequencer, PatternCollection, FieldWarp
